...
#  さい。
#--------------------------------------------------------------------
$IMAGE_URL = 'http://www.hdg.jp/images';
...
#    としてください。
#--------------------------------------------------------------------
@MY_SITE_URLs = ('http://www.yakuohji.com','http://www.t-net.ne.jp','http://www.hdg.jp');
...
$ANA_REQUESTDAILY = 1;		#日別アクセス数レポート
...
$ANA_VIDEOMEMORY = 1;		#クライアントビデオメモリーサイズ レポート
